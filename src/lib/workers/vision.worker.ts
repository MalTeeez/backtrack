/**
 * A worker of the vision pool (src/lib/vision/pool.ts): runs one task at a time with its own OpenCV. Arguments that
...
import { matchMinimap, type Mosaic, type Template } from '../vision/minimap.ts';
